      ...
      <div className="bg-white dark:bg-black px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
        <div className="">
          <div className="mt-3 text-center sm:mt-0 sm:mx-4 sm:text-left">
            ...
            <div className="mt-4">
              <label htmlFor={`${id}-take`} className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                Results per page
              </label>
              <select
                id={`${id}-take`}
              ...
              >
                {allTakes
                  .filter(take => maxLimit == null || take <= maxLimit)
                  .map(take => (
            ...
            <div className="mt-4 flex items-center py-4 border-b border-gray-200 dark:border-gray-800">
              ...
              />
              <label className="ml-3 block text-gray-700 dark:text-gray-300" htmlFor={`${id}-allColumns`}>
                View all columns
              </label>
            </div>
