...
export default function FilterViews({ definitions, columns, className, onDone, onChange }: FilterViewsProps) {
    ...
    return (
        <div className={`px-4 sm:px-6 lg:px-8 text-sm ${className || ''}`}>
